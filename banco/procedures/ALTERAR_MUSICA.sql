...
CALL MSG_SUCESSO('ALTERAR_MUSICA', P_MUS_NOME, V_ART_NOME,NULL,NULL,NULL, P_OK, P_RETORNO); 
		          -- A música :param1 foi alterada para o artista :param2 com sucesso.
